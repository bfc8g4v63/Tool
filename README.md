...
- 從過去工作經驗中受到的澆灌、教育、訓練，該立些Flag #2025年1月Dev深度學習!
- 每天撥攏一點時間無論上班、下班、休假都讓自己維持內化自我。
- #Prompt engineering
- #Vibe coding
- #Almost by my self (Think & Do)
- 不同時期學習自定義不同方式的AI，或許不是最佳..但是正在飛速學習並快樂著。
- 一切都在探索、質疑、反覆互動下，結合工作上的同仁碰上的問題當作一場遊戲任務概念來協助，透過知識解決問題。
- 分析行為>交叉驗證>解決對策，不斷的嘗試學習新事物，如架構、框架、實作、探索過程碰到的這一切就像福爾摩斯探案一般有趣。
- 無論部門內外的同仁、夥伴們能為他們解決問題及服務人群，獲得別人的笑容及讚許，挺有成就感。

這是我在透過AI語言模型下從 2025/04/22 開始深度學習Python，透過工作面臨大大小小的問題起因中，嘗試開發自學、實作、整合展示頁。
---
